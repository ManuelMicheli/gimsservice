...
export default function Manifesto() {
  return (
    <section id="manifesto" className="py-24 md:py-32">
      <ManifestoScroll>
      {/* ===== MOBILE — Sticky Scroll verticale: foto sticky che cambia + 3 capitoli in cross-fade ===== */}
      <div data-manifesto className="md:hidden">
        <div className="relative h-[280vh]">
          <div className="sticky top-0 flex h-[100svh] flex-col">
            {/* IMMAGINE — cross-fade tra le 3 */}
            <div className="relative h-[46vh] w-full shrink-0 overflow-hidden bg-line">
            ...
            {/* TESTO — 3 capitoli in cross-fade */}
            <div className="relative flex-1">
              ...
              >
                ...
                <p className="mt-5 font-body text-[0.9rem] leading-relaxed text-ink">
              ...
              <div
                ...
                style={{ opacity: 0 }}
              >
                <p className="font-body text-[0.9rem] leading-relaxed text-ink">
                ...
                <p className="mt-5 font-display text-xl italic text-accent">— José Giardino, geometra</p>
              </div>
            </div>
          </div>
        </div>
