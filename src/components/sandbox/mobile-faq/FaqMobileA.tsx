...
// A · Clean Accordion — hairline, toggle +, una aperta per volta (mobile-tuned dell'attuale).
export default function FaqMobileA() {
        ...
        {FAQ_TEASER.map((f, i) => {
          ...
          return (
            <div key={f.q} className="border-b border-line">
              ...
              >
                <span className="font-display text-[1.2rem] font-light leading-snug text-ink">{f.q}</span>
