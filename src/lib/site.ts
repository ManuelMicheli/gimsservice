...
export const SERVICES: Service[] = [
  ...
  { n: "02", title: "Decorazioni e Spatolati", img: "cover-decorazioni", slug: "decorazioni-spatolati", desc: "Decorazioni, velature, effetti materici e spatolati con materiali certificati e tecniche professionali, per superfici di pregio che resistono nel tempo." },
  { n: "03", title: "Cartongesso", img: "cover-cartongesso", slug: "cartongesso", desc: "Pareti e controsoffitti in cartongesso con materiali certificati e tecniche professionali." },
  { n: "04", title: "Pavimenti e Rivestimenti", img: "cover-pavimenti", slug: "pavimenti-e-rivestimenti", desc: "Fornitura e posa di pavimenti in piastrelle, laminato, PVC e parquet, con materiali certificati e tecniche professionali." },
  { n: "05", title: "Tapparelle", img: "tapparelle", slug: "tapparelle", desc: "Installazione e manutenzione di tapparelle con materiali resistenti e lavorazioni accurate." },
  { n: "06", title: "Manutenzione Stabili", img: "cover-manutenzione", slug: "manutenzione-stabili", desc: "Manutenzione ordinaria e straordinaria di stabili, con interventi programmati e materiali certificati." },
];
...
export const PARTNERS = [
  ...
  { label: "Impianti Fotovoltaici", key: "fotovoltaico" },
];
...
export const FAQ_TEASER = [
  ...
  { q: "Lavorate anche fuori Bareggio?", a: "Sì: copro Bareggio e tutto l'ovest milanese, dai comuni limitrofi come Corbetta e Sedriano fino a Milano e al suo hinterland." },
];
